...
<div class="max-w-2xl mx-auto mt-10 bg-white p-6 rounded shadow">
    <h2 class="text-2xl font-bold mb-6">File a Leave</h2>
        <div class="bg-gray-100 p-4 rounded mb-4">
            ...
            <p>Vacation Leave: <strong><?php echo e($user->vacation_leave_credits); ?></strong></p>
            <p>Sick Leave: <strong><?php echo e($user->sick_leave_credits); ?></strong></p>
        </div>
    ...
    <form action="<?php echo e(route('leaves.store')); ?>" method="POST">
        ...
        <div class="flex justify-between">
            <div class="flex justify-start">
                <a href="<?php echo e(route('leaves.index')); ?>"class="bg-red-600 text-white px-6 py-2 rounded hover:bg-red-700">Cancel</a>
            </div>
            <div class="flex justify-start">
