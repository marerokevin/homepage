...
<section class="max-w-5xl mx-auto p-6"
                ...
                <div x-show="open"
                    ...
                    <div class="py-1">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $archives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $archive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php if($currentYear !== $archive->year): ?>
                                ...
                                <?php $currentYear = $archive->year; ?>
                            <?php endif; ?>
                            <a href="<?php echo e(route('updates', ['year' => $archive->year, 'month' => $archive->month])); ?>"
                        ...
                        <a href="<?php echo e(route('updates')); ?>" class="block px-4 py-2 text-sm text-indigo-600 font-bold hover:bg-gray-50 dark:hover:bg-gray-900 text-center">
                            View All Posts
                        </a>
                    </div>
                </div>
    ...
    <?php if($singlePost): ?>
        <article class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
            <a href="<?php echo e(route('updates')); ?>" class="text-indigo-600 dark:text-indigo-400 font-bold text-sm mb-6 inline-flex items-center hover:underline">
                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                Back to all updates
            </a>

            <div class="text-xs text-indigo-500 font-bold uppercase tracking-widest mb-2">
                <?php echo e(\Carbon\Carbon::parse($singlePost->event_date)->format('M d, Y')); ?>
            ...
            <div class="text-xs text-gray-500 dark:text-gray-400 mb-2">
                <?php echo e($singlePost->location ?? 'Location not specified'); ?>

            </div>

            <?php if($singlePost->image && is_array($singlePost->image)): ?>
                <div x-data="{ activeImage: 0, images: <?php echo e(json_encode($singlePost->image)); ?> }" class="relative group mb-8">
            ...
            <div class="prose prose-indigo dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 leading-relaxed text-lg">
                <?php echo nl2br(e($singlePost->body)); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col transition hover:shadow-lg">
                    <?php if($post->image && is_array($post->image) && count($post->image) > 0): ?>
                    <div class="relative w-full h-20 overflow-hidden rounded-2xl shadow-lg bg-gray-100 dark:bg-gray-900">
                        <img
                            src="<?php echo e(asset('storage/' . $post->image[0])); ?>"
                    ...
                    <div class="p-6 flex-1">
                        <div class="text-xs text-indigo-600 font-bold uppercase mb-2">
                            <?php echo e(\Carbon\Carbon::parse($post->event_date)->format('M d, Y')); ?>

                        </div>
                        <h3 class="text-xl font-extrabold text-gray-900 dark:text-white mb-3"><?php echo e($post->title); ?></h3>
                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-2">
                            <?php echo e($post->location ?? 'Location not specified'); ?>

                        </div>
                        <p class="text-gray-600 dark:text-gray-400 text-sm line-clamp-3 leading-relaxed">
                            <?php echo e(Str::limit($post->body, 140)); ?>
                    ...
                    <div class="px-6 py-4 mt-auto grid grid-cols-2 items-center border-t border-gray-50 dark:border-gray-700 min-h-20">
                        <!-- Left: Read Article -->
                        <div>
                            <a href="<?php echo e(route('updates', $post->slug)); ?>"
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(auth()->id() === $post->user_id): ?>
                                    ...
                                    <button
                                        @click="
                                            showEditModal = true;
                                            editPost = <?php echo e($post->toJson()); ?>;
                                    ...
                                    <!-- Delete button -->
                                    <button onclick="openPostOtpModal(<?php echo e($post->id); ?>, '<?php echo e(addslashes($post->title)); ?>', 'post-<?php echo e($post->id); ?>')"
...
<?php echo $__env->make('partials.post-otp-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kmarero/Documents/Projects/lara_home/home/home/resources/views/updates.blade.php ENDPATH**/ ?>