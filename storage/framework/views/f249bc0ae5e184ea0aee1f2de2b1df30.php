...
<head>
    ...
    <title>Vehicle Request Report — <?php echo e($from); ?> to <?php echo e($to); ?></title>
    <style>
...
<div class="header">
    ...
    <div class="header-right">
        ...
        <?php echo e(\Carbon\Carbon::parse($from)->format('F d, Y')); ?> — <?php echo e(\Carbon\Carbon::parse($to)->format('F d, Y')); ?>

        <br>Generated: <?php echo e(now()->format('F d, Y g:i A')); ?>
...
<div class="month-section">
    <div class="month-title"><?php echo e($month->format('F Y')); ?></div>
    <div class="cal-wrapper">
        <div class="cal-header">
            ...
            <div class="cal-header-cell <?php echo e($idx === 0 ? 'sun' : ''); ?>"><?php echo e($day); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <div class="cal-grid">
            <?php $__currentLoopData = $cells; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colIdx => $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $isSunday  = ($colIdx % 7) === 0;
            ...
            ?>
            <div class="cal-cell
                <?php echo e($cell['other'] ? 'other-month' : ''); ?>

                <?php echo e($isToday ? 'today' : ''); ?>

                <?php echo e($hasOvernight ? 'has-overnight' : ($hasDay ? 'has-day-trip' : '')); ?>

            ">
                <div class="day-num
                    <?php echo e($isToday ? 'today-num' : ''); ?>

                    <?php echo e(!$isToday && $cell['other'] && $isSunday ? 'other-sun' : ''); ?>

                    <?php echo e(!$isToday && $cell['other'] && !$isSunday ? 'other-num' : ''); ?>

                    <?php echo e(!$isToday && !$cell['other'] && $isSunday ? 'sun-num' : ''); ?>
                ...
                <?php
                    ...
                    $returnStr  = $t->return_time
                        ...
                        : '—';
                ?>
                <div class="trip-tag <?php echo e($isON ? 'overnight-tag' : ''); ?>">
                    <div class="trip-dest">🚗 <?php echo e($t->destination); ?></div>
                    <div class="trip-meta">
                        <?php echo e($t->vehicle); ?> · <?php echo e($t->plate); ?><br>
                        🕐 <?php echo e($departure); ?> → 🔁 <?php echo e($returnStr); ?><br>
...
<div class="footer">
    ...
    <span><?php echo e(\Carbon\Carbon::parse($from)->format('M d, Y')); ?> to <?php echo e(\Carbon\Carbon::parse($to)->format('M d, Y')); ?></span>
</div>

</body>
</html>
<?php /**PATH /home/kmarero/Documents/Projects/lara_home/home/home/resources/views/reports/vehicle_pdf.blade.php ENDPATH**/ ?>